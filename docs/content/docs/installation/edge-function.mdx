...
<Callout type="warn">
**Important**: If you're using TypeScript, you must exclude the Supabase functions directory from your project's TypeScript compilation. The edge function uses Deno runtime which has different types than Node.js.
</Callout>
